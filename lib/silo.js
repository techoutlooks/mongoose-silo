...
class Silo {
  ...
  _registerModels(db, tenantify = true) {
    ...
    if (!Object.keys(db.models).length) { // avoid re-compiling schemas
      ...
      let modelFiles = [readFileSync(this.modelsPath+'/coreModels/Admin.js')]
      ...
      modelFiles.forEach(filePath => {
        ...
        console.log('XXXX 3) _registerModels', filePath)
...
function _getModelFiles(dir, files = []) {
