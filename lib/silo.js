  ...
  _registerModels(db, tenantify = true) {
    ...
    if (!Object.keys(db.models).length) {
      ...
      modelFiles.forEach(filePath => {
        ...
        console.log('module.paths 1) ->', module.paths);
        module.paths = [...module.paths, process.cwd() + '/node_modules', process.cwd() + '/api/models']
        console.log('module.paths 2) ->', module.paths);
        console.log('require.resolve ->', eval('require.resolve(modelPath)'));
